...
export const TEAMS: [string, string, string, string, string][] = [['Baltimore', 'Crabs', 'BAL', 'East', 'Atlantic'], ['Hartford', 'Underwriters', 'HFD', 'East', 'Atlantic'], ['Brooklyn', 'Trolleys', 'BKN', 'East', 'Atlantic'], ['Newark', 'Bricks', 'NWK', 'East', 'Atlantic'], ['Providence', 'Jewelers', 'PRV', 'East', 'Atlantic'], ['Cleveland', 'Amps', 'CLE', 'East', 'Central'], ['Detroit', 'Motors', 'DET', 'East', 'Central'], ['Columbus', 'Explorers', 'CBS', 'East', 'Central'], ['Pittsburgh', 'Inclines', 'PIT', 'East', 'Central'], ['Cincinnati', 'Riverboats', 'CIN', 'East', 'Central'], ['Charlotte', 'Racers', 'CHA', 'East', 'Southeast'], ['Atlanta', 'Firebirds', 'ATL', 'East', 'Southeast'], ['Tampa', 'Corsairs', 'TPA', 'East', 'Southeast'], ['Raleigh', 'Oaks', 'RAL', 'East', 'Southeast'], ['Nashville', 'Sound', 'NSH', 'East', 'Southeast'], ['Seattle', 'Roasters', 'SEA', 'West', 'Northwest'], ['Portland', 'Lumberjacks', 'POR', 'West', 'Northwest'], ['Vancouver', 'Orcas', 'VAN', 'West', 'Northwest'], ['Kansas City', 'Pitmasters', 'KC', 'West', 'Northwest'], ['Denver', 'Altitude', 'DEN', 'West', 'Northwest'], ['San Diego', 'Surf', 'SD', 'West', 'Pacific'], ['Oakland', 'Redwoods', 'OAK', 'West', 'Pacific'], ['Las Vegas', 'High Rollers', 'LV', 'West', 'Pacific'], ['Sacramento', 'Prospectors', 'SAC', 'West', 'Pacific'], ['San Jose', 'Circuits', 'SJ', 'West', 'Pacific'], ['Austin', 'Bats', 'AUS', 'West', 'Southwest'], ['San Antonio', 'Vaqueros', 'SA', 'West', 'Southwest'], ['Phoenix', 'Saguaros', 'PHX', 'West', 'Southwest'], ['Dallas', 'Wildcatters', 'DAL', 'West', 'Southwest'], ['St. Louis', 'Arches', 'STL', 'West', 'Southwest']];
// San Jose and San Antonio replaced Honolulu and Albuquerque (metros under 1 million), and
