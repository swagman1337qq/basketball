...
export function natDefault() { return { US: 3050, CA: 55, FR: 50, RS: 40, AU: 38, ES: 25, DE: 25, BR: 22, NG: 22, HR: 20, LT: 17, GR: 15, TR: 15, AR: 14, SI: 13, SN: 12, IT: 12, GB: 12, CD: 10, CM: 9, DO: 9, LV: 8, GE: 8, BS: 8, ME: 8, BA: 8, CN: 7, PR: 6, MX: 6, IL: 5, ML: 4, SS: 4, JP: 4, NZ: 4, FI: 3, PH: 2, KR: 1, KE: 1 }; }

export function regions() { return { NA: { name: 'North America', tier: 1, arche: 'Athletic wings, lead guards', c: ['US', 'CA', 'BS', 'PR', 'DO', 'MX'] }, WEU: { name: 'Western Europe', tier: 1, arche: 'Skilled bigs, 3-and-D wings', c: ['FR', 'ES', 'DE', 'IT', 'GB', 'FI'] }, BAL: { name: 'Balkans', tier: 1, arche: 'Playmaking bigs, shooters', c: ['RS', 'HR', 'SI', 'ME', 'BA'] }, EEU: { name: 'Baltics, Türkiye & Caucasus', tier: 2, arche: 'High-IQ forwards', c: ['LT', 'LV', 'TR', 'GE', 'IL'] }, AFR: { name: 'Africa', tier: 2, arche: 'Long, athletic rim protectors', c: ['NG', 'SN', 'ML', 'CM', 'CD', 'SS', 'KE'] }, OCE: { name: 'Oceania', tier: 2, arche: 'Tough two-way guards', c: ['AU', 'NZ'] }, SAM: { name: 'South America', tier: 3, arche: 'Physical forwards', c: ['BR', 'AR'] }, ASI: { name: 'East Asia & Pacific', tier: 3, arche: 'Shooters, tall centers', c: ['CN', 'JP', 'KR', 'PH'] } }; }
