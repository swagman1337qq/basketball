...
function deepSteps(vm: VM): Step[] {
  ...
  return [
    ...
    { section: 'League tabs', title: 'Predictions', lines: ['Before every season the media makes its picks: PEEN, The Donger, Bleacher Retort, The Athleisure, Sports Illiterated, Fox Spurts and the DraftQueens sportsbook. Each has its own biases.', 'Projected standings, title and award picks, and every outlet’s top 100 players. After the season, see who got it right. Mock drafts are on the Draft tab.'], screen: 'preds' },
    ...
    { section: 'Your team', title: 'Locker room and mentors', lines: ['The locker room (on the Roster) is team morale: happy players, veteran leaders and winning lift it; selfish or unhappy players drag it down.', 'Pair a young player with a veteran Professional or Team player. Personalities rarely change, but some players are open to it.'], screen: 'dev' },
