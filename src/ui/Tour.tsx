...
export function tourSteps(vm: VM): Step[] {
  ...
  return [
    ...
    { title: 'Playing games', lines: ['Play a day, a week or a month at a time. 82 games, then the playoffs.', 'Click any step in this bar (Play-in, Playoffs, Lottery…) to see it as if the season ended today.'], target: 'phase' },
    ...
    { title: 'The draft lottery', lines: ['Teams that miss the playoffs get lottery balls for the top young players.', 'Losing on purpose doesn’t pay: the three worst teams get fewer balls.'], screen: 'lottery' },
    { title: 'The draft', lines: ['Then each team picks a player. Scouting reports tell you who’s worth it.'], screen: 'draft' },
